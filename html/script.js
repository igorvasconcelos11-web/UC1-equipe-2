document.addEventListener('DOMContentLoaded', () => {
  const asset = (folder, file) => `../${folder}/${folder}/${encodeURIComponent(file)}`;
  const products = [
    { category: 'frios', title: 'Sorvete Blue Ice', price: 'R$ 14,00', food: 'Sorvete Blue Ice - Lilo & Stitch.png', character: 'Lilo & Stich - Sorvete Blue Ice.png', characterSide: 'left', characterAnchor: 'bottom', characterSize: 'large', desc: 'Sorvete azul cremoso inspirado em Lilo & Stitch, com uma apresentação gelada e divertida.' },
    { category: 'frios', title: 'Milkshake Frozen', price: 'R$ 16,00', food: 'MilkShake - Frozen.png', character: 'Elsa (Frozen) - Milkshake.png', characterSide: 'left', characterAnchor: 'bottom', characterSize: 'large', desc: 'Milkshake cremoso e refrescante inspirado no universo de Frozen.' },
    { category: 'frios', title: 'Mochi de Morango', price: 'R$ 15,00', food: 'Mochi de Morango - Mulan.png', character: 'Mulan - Mochi de Morango.png', characterSide: 'right', characterAnchor: 'bottom', characterSize: 'large', desc: 'Mochi macio de morango, inspirado na delicadeza e coragem de Mulan.' },
    { category: 'frios', title: 'Macaron Colorido', price: 'R$ 12,00', food: 'Macaron - Divertidamente.png', character: 'Divertidamente - Macaron Colorido.png', cleanCharacter: 'images/personagens-limpos/divertidamente-macaron-sem-fundo.png', cutout: true, characterSide: 'left', characterAnchor: 'top', characterSize: 'large', desc: 'Macarons coloridos e leves, inspirados nas emoções de Divertida Mente.' },
    { category: 'quentes', title: 'Brownie de Mel', price: 'R$ 14,00', food: 'Brownie de Mel - Alladin.png', character: 'Alladin - Brownie de Mel.png', cleanCharacter: 'images/personagens-limpos/alladin-brownie-sem-fundo.png', characterSide: 'left', characterAnchor: 'bottom', characterSize: 'large', desc: 'Brownie intenso com fio de mel dourado, inspirado nas aventuras de Aladdin.' },
    { category: 'quentes', title: 'Cookie de Chocolate', price: 'R$ 10,00', food: 'Cookie de Chocolate - Tico e Teco.png', character: 'Tico e Teco - Cookie de Chocolate.png', characterSide: 'center', characterAnchor: 'bottom', characterSize: 'presenter', desc: 'Cookie quentinho com gotas de chocolate, inspirado na dupla Tico e Teco.' },
    { category: 'quentes', title: 'Bolo de Cenoura', price: 'R$ 11,00', food: 'Bolo de Cenoura - Zootopia.png', character: 'Judy (Zootopia) - Bolo de Cenoura.png', characterSide: 'right', characterAnchor: 'bottom', characterSize: 'large', desc: 'Bolo de cenoura macio com cobertura de chocolate, inspirado em Zootopia.' },
    { category: 'quentes', title: 'Cupcake de Mel', price: 'R$ 13,00', food: 'Cupcake de Mel - Ursinho Pooh.png', character: 'Ursinho Pooh - Cupcake de Mel.png', characterSide: 'right', characterAnchor: 'bottom', characterSize: 'large', desc: 'Cupcake fofinho com mel, feito para os fãs do Ursinho Pooh.' },
    { category: 'doces', title: 'Donut Rosa', price: 'R$ 12,00', food: 'Donut - Detona Ralph.png', character: 'Vanellope (Detona Ralph) - Donut Rosa.png', characterSide: 'left', characterAnchor: 'bottom', characterSize: 'large', desc: 'Donut rosa com cobertura brilhante, inspirado em Vanellope e Detona Ralph.', featured: true },
    { category: 'doces', title: 'Maçã do Amor', price: 'R$ 11,00', food: 'Maçã do Amor - Branca de Neve.png', character: 'Branca de Neve - Maçã do Amor.png', characterSide: 'left', characterAnchor: 'bottom', characterSize: 'large', desc: 'Maçã do amor crocante inspirada no conto da Branca de Neve.' },
    { category: 'doces', title: 'Brigadeiro de Coco', price: 'R$ 8,00', food: 'Brigadeiro de Coco - Moana.png', character: 'Moana - Brigadeiro de Coco.png', characterSide: 'left', characterAnchor: 'bottom', characterSize: 'large', desc: 'Brigadeiro de coco com clima tropical inspirado em Moana.' },
    { category: 'doces', title: 'Brigadeiro de Doce de Leite', price: 'R$ 8,00', food: 'Brigadeiro de Doce de Leite - Rei Leão.png', character: 'Rei Leão - Brigadeiro de  Doce de Leite.png', characterSide: 'right', characterAnchor: 'bottom', characterSize: 'large', desc: 'Brigadeiro de doce de leite inspirado na savana de O Rei Leão.' }
  ].map(product => ({ ...product, img: asset('doces.img', product.food), characterImg: product.cleanCharacter ? `../${product.cleanCharacter}` : asset('personagens.img', product.character) }));
  ...
  let category = 'frios'; let index = 0; let changing = false; const cart = [];
  ...
  els.add.addEventListener('click', () => { const product = visibleProducts()[index]; cart.push(product); els.feedback.textContent = `${product.title} adicionado ao pedido (${cart.length})`; window.setTimeout(() => els.feedback.textContent = '', 2600); });
